...
<meta name="csrf-token" content="{{ csrf_token() }}">
 ...
 <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.17.47/css/bootstrap-datetimepicker.min.css" rel="stylesheet" media="screen">
 <style type="text/css">
         .cc-selector input{
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ url('css/header_all.css') }}" >
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/alertify.js/0.3.11/alertify.default.css" id="toggleCSS" />
...
<!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('css/main-colors.css') }}" />
