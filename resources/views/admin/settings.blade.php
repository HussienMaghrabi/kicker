            ...
            <form action={{url(adminPath().'/settings')}} method="post" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-12 @if($errors->has('mail_provider')) has-error @endif">
                    ...
                    <select class="form-control select2" name="mail_provider"
                        ...
                        <option @if($settings->mail_provider == 'outlook') selected @endif value="outlook">{{ __('admin.outlook') }}</option>
                ...
                <div class="form-group col-md-3 @if($errors->has('leads_mail')) has-error @endif">
                    <label>{{ trans('admin.cil_email') }}</label>
                    <input type="text" name="cil_email" class="form-control" value="{{ $settings->cil_email }}"
                           placeholder="{!! trans('admin.cil_email') !!}">
                </div>
                <div class="form-group col-md-3 @if($errors->has('lead_mail_password')) has-error @endif">
                    <label>{{ trans('admin.cil_password') }}</label>
                    <input type="text" name="cil_password" class="form-control" value="{{ $settings->cil_password }}"
                           placeholder="{!! trans('admin.cil_password') !!}">
                </div>
                ...
                <div class="col-md-12">
                    <div class="input-group">
                        <label>Request page background</label>
                ...
                @endforeach
                <div class="form-group @if($errors->has('maintenance')) has-error @endif col-md-6"
                         id="PhoneOld{{ $phone->id }}">
                         <label>Website Under Maintenance</label>
                    <input type="hidden" name="maintenance" value="0">
                    <input type="checkbox" name="maintenance" class="switch-box"
                                data-on-text="{{ __('admin.yes') }}"
                                data-off-text="{{ __('admin.no') }}"
                                @if($settings->maintenance) checked @endif value="1">
                </div>
