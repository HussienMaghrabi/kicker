...
{{--@php( $columns = Schema::getColumnListing('banks') )--}}
        ...
        <div class="box-body">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="income">
                    ...
                    <table id="example1" class="table datatable table-striped table-bordered  dt-responsive nowrap" style="width:100%">
                        <thead>
                        <tr>
    ...
    <div id="add_income" class="modal" role="dialog">
    ...
    <div id="add_outcome" class="modal" role="dialog">
        <div class="modal-dialog">
