    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="row setting_dashboard">
                <a href="{{ url(adminPath().'/dailyreportsbycall') }}">
                    <div class="single_box">
                        <i class="fa fa-id-card" aria-hidden="true"></i>
                        <span>Report By CAll</span>
                    </div>
                </a>

                <a href="{{ url(adminPath().'/allarchive') }}">
                    <div class="single_box">
                        <i class="fa fa-id-card" aria-hidden="true"></i>
                ...
                @if(checkRole('settings') or @auth()->user()->type == 'admin')
                   <a href="{{ url(adminPath().'/vue/DuplicatedLeads') }}">
                      <div class="single_box">
                          <i class="fa fa-clone" aria-hidden="true"></i>
                          <span>Duplicated Leads</span>
                      </div>
                   </a>
                @endif
                @if(checkRole('settings') or @auth()->user()->type == 'admin')
                   <a href="{{ url(adminPath().'/vue/LeadSummaries') }}">
                      <div class="single_box">
                ...
                @endif
                <a href="{{ url(adminPath().'/dailyreports') }}">
                    <div class="single_box">
                        <i class="fa fa-id-card" aria-hidden="true"></i>
                        <span>Daily Report</span>
                    </div>
                </a>
                <a href="{{ url(adminPath().'/vue/agent_type') }}">
                    <div class="single_box">
                        <i class="fa fa-id-card" aria-hidden="true"></i>
                        <span>{{ trans('admin.agent_types') }}</span>
                    </div>
                </a>
                <a href="{{ url(adminPath().'/vue/agents') }}">
                    <div class="single_box">
                ...
                <a href="{{ url(adminPath().'/vue/action_logs') }}">
                    <div class="single_box">
                ...
                <a href="{{ url(adminPath().'/vue/tags') }}">
                    <div class="single_box">
                        <i class="fa fa-tags" aria-hidden="true"></i>
                        <span>{{ trans('admin.tags') }}</span>
                    </div>
                </a>
                <a href="{{ url(adminPath().'/vue/facilities') }}">
                    <div class="single_box">
                ...
                <a href="{{ url(adminPath() . '/vue/meeting_status') }}">
                    <div class="single_box">
                        <i class="fa fa-handshake-o" aria-hidden="true"></i>
                ...
                <a href="{{ url(adminPath() . '/vue/outcome_category') }}">
                    <div class="single_box">
                        <i class="fa fa-money" aria-hidden="true"></i>
                ...
                <a href="{{ url(adminPath() . '/vue/sub_categories') }}">
                    <div class="single_box">
                        <i class="fa fa-money" aria-hidden="true"></i>
                ...
                @endif
                @if(checkRole('settings') or @auth()->user()->type == 'admin')
                   <a href="{{ url(adminPath().'/vue/filterLeadsToDelete') }}">
                      <div class="single_box">
                          <i class="fa fa-trash" aria-hidden="true"></i>
                          <span>Filter And Delete Leads</span>
                      </div>
                   </a>
                @endif
                @if(checkRole('settings') or @auth()->user()->type == 'admin')
                   <a href="{{ url(adminPath().'/reformLeadPhones') }}">
                      <div class="single_box">
                          <i class="fa fa-edit" aria-hidden="true"></i>
                          <span>Reform Lead Phones</span>
                      </div>
                   </a>
                @endif
                @if(checkRole('settings') or @auth()->user()->type == 'admin')
                   <a href="{{ url(adminPath().'/vue/cils_mail_settings') }}">
                      <div class="single_box">
                          <i class="fa fa-tasks" aria-hidden="true"></i>
                          <span>Cil Mail Settings</span>
                      </div>
                   </a>
                @endif
                @if(checkRole('settings') or @auth()->user()->type == 'admin')
                   <a href="{{ url(adminPath().'/vue/lead_data') }}">
                      <div class="single_box">
