...
<script src="{{ url('js/bootstrap_footer_all.js') }}"></script>
<!-- ./wrapper -->
<!-- jQuery 3 -->
<script src="https://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.2.1.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-throttle-debounce/1.1/jquery.ba-throttle-debounce.min.js"></script>
{{-- <script src="{{ url('js/jquery.ba-throttle-debounce.js') }}"></script> --}}

{{-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script> --}}
{{-- <script src="{{ url('js/asIconPicker.js') }}"></script> --}}
<!-- jQuery UI 1.11.4 -->
...
<!-- Morris.js charts -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/raphael/2.2.0/raphael.js"></script>
...
<!-- AdminLTE App -->
<script src="{{ url('js/footer_all.js') }}"></script>
...
<!--<script src="https://cdn.jsdelivr.net/npm/vue@2.1.10/dist/vue.min.js"></script>-->
<!--<script src="https://unpkg.com/axios/dist/axios.min.js"></script>-->
{{-- <script src="{{ url('dashboard_employee/js/calender/moment.latest.min.js') }}"></script>
<script src="{{ url('dashboard_employee/js/calender/pignose.calender.min.js') }}"></script> --}}
{{-- <script src="{{ url('dashboard_employee/js/calender/pignose.init.js') }}"></script> --}}
{{-- <script src="{{ url('dashboard_employee/js/calender/prism.min.js') }}"></script> --}}
<!-- <script src="{{ url('/js/semantic.min.js') }}"></script> -->

{{-- <script src="{{ url('dashboard_employee/js/charts/morris.js') }}"></script> --}}
<script src="https://cdnjs.cloudflare.com/ajax/libs/raphael/2.2.7/raphael.min.js"></script>
{{-- <script src="{{ url('dashboard_employee/js/charts/raphael-min.js') }}"></script> --}}


{{-- <script src="{{ url('dashboard_employee/js/owl-carousel/owl.carousel.min.js') }}"></script> --}}
{{-- <script src="{{ url('dashboard_employee/js/owl-carousel/owl.carousel-init.js') }}"></script> --}}



{{-- <link rel="preload" href="https://adservice.google.com.eg/adsid/integrator.js?domain=www.cssscript.com" as="script"> --}}
{{-- <script src="https://pagead2.googlesyndication.com/pagead/js/r20180702/r20180604/osd.js"></script> --}}
{{-- <script async="" src="//www.google-analytics.com/analytics.js"></script> --}}
{{-- <script src="https://pagead2.googlesyndication.com/pub-config/r20160913/ca-pub-2783044520727903.js"></script> --}}
{{-- <script type="text/javascript" src="https://adservice.google.com.eg/adsid/integrator.js?domain=www.cssscript.com"></script> --}}
