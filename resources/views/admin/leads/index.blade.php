    ...
    <div class="filter"  id="vue-panel">
                ...
                <div id="accordion" class="panel-group">
                        ...
                        <div class="collapse" id="add_call" aria-labelledby="headingCall" data-parent="#accordion">
                            ...
                            <div class="form-group @if($errors->has('contact_id')) has-error @endif" id="contact">
                                ...
                                <select  name="contact_id" class="form-control select2" id="contact_id" style="width: 100%"
                                        data-placeholder="{{ trans('admin.contact') }}" required="">
                            ...
                            <div class="form-group @if($errors->has('date')) has-error @endif">
                                ...
                                <div class="input-group">
                                    <input placeholder="Date" id="call_date" readonly="readonly" name="date" type="text" value="" class="form-control datepicker" required="">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                </div>
                            </div>
                            <div class="form-group @if($errors->has('probability')) has-error @endif">
                                <label>{{ trans('admin.probability') }}</label>
                                <select class="form-control select2" id="callprobability" name="probability" style="width: 100%" data-placeholder="{{ __('admin.probability') }}" required="">
                                    <option value=""></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input placeholder="Budget" id="callbudget" name="budget" type="number" value="" class="form-control" required="">
                            ...
                            <div class="form-group @if($errors->has('description')) has-error @endif">
                                ...
                                <textarea placeholder="Description" rows="5" name="description" cols="50" class="form-control" id="calldescription" required=""></textarea>
                            </div>
                    ...
                    <div id='headingMeet' class="actionTab panel-title">
                        ...
                        <div class="collapse" id="add_meeting" aria-labelledby="headingMeet" data-parent="#accordion">
                            ...
                            <div class="form-group @if($errors->has('duration')) has-error @endif">
                                <label>{{ trans('admin.duration') }}</label>
                                <input class="form-control" placeholder="Duration" name="duration" type="number" value="" id="meetingduration" required="">
                            </div>
                            ...
                            <div class="form-group @if($errors->has('date')) has-error @endif">
                                <label>{{ trans('admin.date') }}</label>
                                <div class="input-group">
                                    <input class="form-control datepicker" placeholder="Date"  name="date" type="text" value="" id="date_meeting" required="">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group @if($errors->has('probability')) has-error @endif">
                                <label>{{ trans('admin.probability') }}</label>
                                <select class="form-control select2" name="probability" id="meetingprobability"  style="width: 100%" data-placeholder="{{ __('admin.probability') }}" required="">
                                    <option></option>
                                    <option value="highest">{{ __('admin.highest') }}</option>
                                    <option value="high">{{ __('admin.high') }}</option>
                                    <option value="normal">{{ __('admin.normal') }}</option>
                            ...
                            <div class="form-group">
                                <label>{{ trans('admin.budget') }}</label>
                                <div class="input-group">
                                    <input placeholder="Budget" id="mettingbudget" name="budget" type="number" value="" class="form-control" required="">
                                    <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group @if($errors->has('description')) has-error @endif">
                                <label>{{ trans('admin.description') }}</label>
                                <textarea placeholder="Description" rows="5" name="description" cols="50" class="form-control" id="meetingdescription" required=""></textarea>
                        ...
                        <div class="collapse" id="add_request" aria-labelledby="headingRequest" data-parent="#accordion">
                            <div class="">
                                    ...
                                    <div class="form-group @if($errors->has('date')) has-error @endif col-md-12">
                                        ...
                                        <div class="input-group">
                                            <input placeholder="Delivery Date" readonly="readonly" id="date" name="date" type="text" value="" class="form-control datepicker2" required="">
        ...
        <div v-if="lead" >
            <div class="row" style=" background: linear-gradient(to right ,#b57800a6, #c48200d1); margin-bottom: 30px;" v-for="req of lead.requests">
                ...
                <div class="col-md-6" >
                    <p>Date: @{{ req.created_at.substring(0,10) }}</p>
...
// });
        ...
        $(document).on('change', '#callStatus', function() {
            ...
            if (action == 1) {
                $('#nextAction').html('<div class="well" id="action">' +
                    ...
                    '<div class="input-group">' +
                    '<input class="form-control datepicker" placeholder="Due Date"  id="calltododuedate" name="to_do_due_date" type="text" value="">' +
                    '<span class="input-group-addon"><i class="fa fa-calendar"></i></span>' +
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
    ...
    <script>
        $(document).on('click', '#MaddAction', function () {
            $('#MnextAction').html('<div class="well" id="action">' +
                ...
                '<label>{{ trans("admin.due_date") }}</label>' +
                '<div class="input-group">' +
                '<input class="form-control datetpicker" placeholder="Due Date"  id="meetingtododuedate" name="to_do_due_date" type="text" value="">' +
                // '{!! Form::text("to_do_due_date","",["class" => "form-control datepicker", "placeholder" => trans("admin.due_date"),"readonly"=>""]) !!}' +
                '<span class="input-group-addon"><i class="fa fa-calendar"></i></span>' +
                '</div>' +
                '</div>' +
    ...
    var root = new Vue({
        ...
        mounted(){
            ...
            // this.f   ilter = document.querySelector('.filter-icon');
        }
    });
        ...
        $(document).on('change', '#meetingStatus', function() {
            ...
            if (action == 1) {
                $('#MnextAction').html('<div class="well" id="Maction">' +
                    ...
                    '<label>{{ trans("admin.due_date") }}</label>' +
                    '<div class="input-group">' +
                    '<input class="form-control datepicker" placeholder="Due Date"  id="meetingtododuedate" name="to_do_due_date" type="text" value="">' +
