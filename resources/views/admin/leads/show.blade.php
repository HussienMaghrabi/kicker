...
@section('content')
    ...
    @endphp
    <div id="mail" class="modal" role="dialog">
    ...
    <div id="compose" class="modal" role="dialog">
        <div class="modal-dialog" style="width: 90%">
    ...
    <div id="addFile" class="modal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">{{ trans('admin.create') . ' ' . trans('admin.new_document') }}</h4>
                     </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 head_margin_top">
            ...
            <div class="col-xs-6">
                ...
                @endif
                <div class="col-xs-12 font-18">
                    {{ trans('admin.created_at') }} :{{ $show->created_at->toFormattedDateString() }}
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            @if(isset($agent))
                <div class="col-md-12">
                    <a href="{{ url(adminPath().'/agent/'.$agent->id) }}" >
                        @if ($agent->image =='')
                            <img src="../../dist/img/lead.png" class="img-circle lead_image"
                    ...
                    <div class="col-xs-12">
                        <i class="fa fa-circle" aria-hidden="true" style="@if(DB::table('lead_actions')->where('lead_id',$show->id)->count() > 0) color:green;@else color:red @endif"></i>
                    ...
                    <div class="modal" id="resAction" tabindex="-1" role="dialog" aria-labelledby="resActionLabel" aria-hidden="true">
            ...
            @endif
                    @if(isset($commercial_agent))
                        ...
                        <div class="modal" id="comAction" tabindex="-1" role="dialog" aria-labelledby="comActionLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">{{ __('admin.actions') }}</h5>
            ...
            <div class="col-md-6">
                <div class="box" id="more-info">
                    <div class="box-header with-border">
                        ...
                        <div id="sendCIL" class="modal" role="dialog">
                            <div class="modal-dialog">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 head_margin_top">
                                {{ trans('admin.form_source') }}
                                :
                                <span id="newComment">{{ @\App\Form::find($show->form_source_id)->{app()->getLocale() .'_title'} }}</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-6" id="actions">
            <div class="box" id="actions-accordion">
                <div class="box-header with-border">
                    ...
                    @php $req =  \App\Request::where('lead_id',$show->id)->with('unittype')->with('loc')->orderBy('created_at', 'desc')->first() @endphp
                    @if($req != null)
                    <br/><br/>
                    <div class="tab-pane" id="requests1">
                        <h3 class="box-title">{{ trans('admin.last_request') }}</h3>
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ $req->unit_type }}</td>
                                    <td>{{ $req->unittype->{app()->getLocale().'_name'} }}</td>
                                    <td>{{ $req->loc->{app()->getLocale().'_name'} }}</td>
                                    <td>{{ @\App\Project::find($req->project_id)->{app()->getLocale() . '_name'} }}</td>
                ...
                <div class="box-body">
                        <div class="panel panel-default">
                            ...
                            <div class="collapse" id="add_call" aria-labelledby="headingCall" data-parent="#accordion">
                                ...
                                {{-- <form  method="post"> --}}
                                <input type="hidden" name="lead_id" id="lead_id" value="{{ $show->id }}">
                                ...
                                <div class="form-group @if($errors->has('call_status_id')) has-error @endif">
                                    ...
                                    <select class="form-control select2" name="call_status_id" id="callStatus" data-placeholder="{{ __('admin.call_status') }}" style="width: 100%" required="">
                                        <option></option>
                                ...
                                <div class="form-group @if($errors->has('date')) has-error @endif">
                                    ...
                                    <div class="input-group">
                                        <input placeholder="Date" id="call_date" readonly="readonly" name="date" type="text" class="form-control datepicker" required="" value="{{ date('Y-m-d') }}">
                                ...
                                <br/>
                                <button type="submit" id="call_add" class="btn btn-primary btn-flat">{{ trans('admin.submit') }}</button>
                                {!! Form::close() !!}
                            </div>
                        </div>
                        <div class="panel panel-default">
                            ...
                            <div class="collapse" id="add_meeting" aria-labelledby="headingMeet" data-parent="#accordion">
                                ...
                                <br/>
                                <button type="submit" id="meeting_add" class="btn btn-primary btn-flat">{{ trans('admin.submit') }}</button>
                                {!! Form::close() !!}
                            </div>
                        </div>
                        <div class="panel panel-default">
                            ...
                            <div class="collapse" id="add_request" aria-labelledby="headingRequest" data-parent="#accordion">
                                <div class="">
                                    {{-- <form action="{{ url(adminPath().'/requests') }}" method="post"> --}}
                                        {!! Form::open(['url' => adminPath().'/requests']) !!}
                                        {{ csrf_field() }}
                                        <input type="hidden" value="{{ $show->id }}" id="request_lead_id" name="lead">
                                        ...
                                        <div class="form-group @if($errors->has('date')) has-error @endif col-md-12">
                                            ...
                                            <div class="input-group">
                                                {!! Form::text('date','',['class' => 'form-control datepicker2', 'placeholder' => trans('admin.delivery_date'),'readonly'=>'','id'=>'date']) !!}
                                        ...
                                        <div class="form-group @if($errors->has('notes')) has-error @endif col-md-12">
                                            ...
                                            <textarea name="notes" class="form-control" value="{{ old('notes') }}"id="notes_request"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <button type="submit" id="request_add"
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="contacts">
                                ...
                                <div id="addContact" class="modal" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                ...
                                <table class="table datatable table-striped table-bordered dataTable no-footer dtr-inline collapsed">
                                    <thead>
                                    <tr>
                                        <th>{{ trans('admin.id') }}</th>
                                    ...
                                    <div id="show{{ $contact->id }}" class="modal" role="dialog">
                                        <div class="modal-dialog">
                                    ...
                                    <div id="delete{{ $contact->id }}" class="modal" role="dialog">
                                        <div class="modal-dialog">
                            ...
                            <div class="tab-pane" id="requests">
                                <table class="table table-hover table-striped datatable">
                                    ...
                                    <tbody>
                                    @foreach(App\Request::where('lead_id',$show->id)->with('unittype')->get() as $req)
                                        <tr>
                                            <td>{{ $req->id }}</td>
                                            ...
                                            <td>{{ $req->price_to }}</td>
                                            <td>{{ $req->date }}</td>
                                            <td><a href="{{ url(adminPath().'/requests/'.$req->id.'/edit') }}"
                            ...
                            <div class="tab-pane" id="notes">
                                <div id="allNotes">
                                    ...
                                    @foreach(@\App\LeadNote::where('lead_id',$show->id)->orderBy('id')->get() as $note)
                                        <div class="well col-md-12">
                                            ...
                                            <button id="noteNumber{{ $note->id }}" onClick="delete_note({{ $note->id }})" type="button" class="close" aria-label="Close" style="float:right;" >
                                                <span aria-hidden="true" style="color:#F00;font-size:30px; border-radius:5px;" >&times;</span>
                                            </button>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <br/>
                                    <button type="button" class="btn btn-flat btn-success"data-target="#noteBTN"
                            ...
                            <div class="tab-pane" id="docs">
                                ...
                                <div class="col-md-12">
                                    <a data-toggle="modal" data-target="#addFile"
                                       class="btn btn-flat btn-primary"  style="margin-top: -95px;float: right;display: block;margin-right: 0px;clear: left;">{{ __('admin.add') }}</a>
                                </div>
                            </div>
                                        ...
                                        @elseif($req->request_type == 'resale')
                                            <div class="well">
                                                ...
                                                <table class="table table-hover table-striped">
                                                    ...
                                                    <div id="sendResale{{ $resaleUnit->id }}" class="modal"
                                                         role="dialog">
                                                        <div class="modal-dialog">
                                        ...
                                        <div class="well">
                                            ...
                                            <table class="table table-hover table-striped">
                                                ...
                                                whereIn('location', $locationsArray)->get() as $land)
                                                    ...
                                                    <div id="delete{{ $land->id }}" class="modal" role="dialog">
                                                        <div class="modal-dialog">
                            ...
                            <div class="tab-pane" id="contracts">
                                ...
                                <table class="table table-hover table-striped datatable">
                                    ...
                                    <div id="deleteContract{{ $contract->id }}" class="modal" role="dialog">
                                        <div class="modal-dialog">
                            ...
                            <div class="tab-content">
                                            ...
                                            <tr data-toggle="tooltip" data-placement="left"
                                                ...
                                                <td>
                                                    <a href="/admin/calls/{{$call->id}}/edit">
                                                        <i class="fa fa-edit edit-table" aria-hidden="true"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <div id="delete{{ $call->id }}" class="modal" role="dialog">
                                            <div class="modal-dialog">
                                ...
                                <div class="tab-pane" id="meetings">
                                    <table class="table table-hover table-striped datatable">
                                        ...
                                        <div id="delete{{ $meeting->id }}" class="modal" role="dialog">
                                            <div class="modal-dialog">
...
<script>
    ...
    $(document).ready(function() {
        var max_height = $('#more-info').css('height');
        $('#actions-accordion').css('max-height', max_height);
        $('#gCallSel').selectable();
        $("#accordion").accordion({
            collapsible:true,
            active:false,
...
<script>
        ...
        $(document).on('change', '#callStatus', function() {
            ...
            if (action == 1) {
                $('#nextAction').html('<div class="well" id="action">' +
                    '<div class="form-group col-md-6">' +
                    '<label>{{ trans("admin.to_do_type") }}</label>' +
                    '<select class="form-control select2" name="to_do_type" id="callnextactiontype" data-placeholder="{{ trans("admin.to_do_type") }}" style="width: 100%">' +
                    '<option></option>' +
                    '<option value="call">{{ trans("admin.call") }}</option>' +
                    '<option value="meeting">{{ trans("admin.meeting") }}</option>' +
                    '<option value="other">{{ trans("admin.other") }}</option>' +
                    ...
                    '<label>{{ trans("admin.due_date") }}</label>' +
                    '<div class="input-group">' +
                    '<input class="form-control datepicker" placeholder="Due Date" readonly="" id="calltododuedate" name="to_do_due_date" type="text" value="">' +
                    '<span class="input-group-addon"><i class="fa fa-calendar"></i></span>' +
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
    ...
    <script>
        $(document).on('change', '#meetingStatus', function() {
            ...
            if (action == 1) {
                $('#MnextAction').html('<div class="well" id="Maction">' +
                    ...
                    '<label>{{ trans("admin.due_date") }}</label>' +
                    '<div class="input-group">' +
                    '<input class="form-control datepicker" placeholder="Due Date" readonly="" id="meetingtododuedate" name="to_do_due_date" type="text" value="">' +
                    // '{!! Form::text("to_do_due_date","",["class" => "form-control datepicker1", "placeholder" => trans("admin.due_date"),"readonly"=>""]) !!}' +
                    '<span class="input-group-addon"><i class="fa fa-calendar"></i></span>' +
                    '</div>' +
                    '</div>' +
     ...
     // alert('tsehkj');
        ...
        /*$.ajax({
            url: "{{ url(adminPath().'/add_call')}}",
            method: 'post',
            data: data,
            success: function (data) {
                console.log('success');
                alertify.success('Success Create');
                // alert('success');
            }
     ...
     $('#meeting_add').click(function(){
      ...
      var meeting_lead_id = $('#meetting_lead_id').val();
      var projects = [];
     ...
     /*$.ajax({
         url: '{{ url(adminPath().'/add_meetings')}}',
         method: 'post',
         data: data,
         success: function (data) {
             console.log('success');
     ...
     $('#request_add').click(function(){
       ...
       var notes = $('#notes_request').val();
       var lead_id = $('#request_lead_id').val();
       ...
       var url =  "{{ url(adminPath().'/add_Request')}}";
...
function delete_note(id){
    axios.post('{{url(adminPath()."/delete_note")}}',
    {
        id:id
    }).then(function(response){
        // console.log($('#noteNuber'+id).css('background',"red"));
        $('#noteNumber'+id).parent().remove();
    })
    .catch(function(err){
        console.log(err);
    });
