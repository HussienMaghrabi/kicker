    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-xs-12 listing1 property-details">
                ...
                <h2 class="text-uppercase">{{ __('admin.description') }} {{ __('admin.property') }}</h2>
                <p class="bottom30">{{ $project->{app()->getLocale().'_description'} }}</p>
                ...
                <h2 class="text-uppercase bottom20">{{ __('admin.quick_summary') }}</h2>
                ...
                <h2 class="text-uppercase bottom20">{{ __('admin.Video Presentation') }}</h2>
                <div class="row bottom40">
        ...
        <!-- new resale come from developer -->
                @if(!empty($resale))
                <div class="col-md-12">
                <div class="row">
                    <div class="col-sm-10">
                        <h2 class="text-uppercase top20">{{ __('admin.developer_resale') }}</h2>
                            ...
                            <div class="item">
                                <div class="property_item heading_space">
                                    <div class="image" style="height: 200px;">
                                        <a href="{{ url('project/'.slug($r->en_name).'-'.$r->id) }}"><img src="{{ url('uploads/'.$r->website_cover) }}" style="height: 200px" alt="latest property" height="120px" class="img-responsive"></a>
                                        <div class="price clearfix">
                                            <span class="tag pull-right">{{ $r->meter_price }} {{ __('admin.per_meter') }}</span>
                                        </div>
                                    ...
                                    <div class="proerty_content">
                                        <div class="proerty_text">
                                            <h3 class="captlize"><a href="#.">{{ $r->{app()->getLocale().'_name'} }}</a></h3>
                                            <p>{{ @App\Location::find($r->location_id)->{app()->getLocale().'_name'} }}</p>
                                        </div>
                                        ...
                                        <div class="property_meta transparent">
                                            @foreach(@App\UnitFacility::where('unit_id',$r->id)->get() as $fac)
                ...
                @endif
                <!-- end resale come from developer -->



                <div class="row">
                    <div class="col-sm-10">
                        <h2 class="text-uppercase top20">{{ __('admin.similar_projects') }}</h2>
                        <p class="bottom30">{{ __('admin.similar_sub') }}</p>
                    </div>
                    <div class="col-sm-12"><div id="two-col-slider" class="owl-carousel project-owl shehab">
                            @foreach($tags as $item)
                            @if(@App\Project::where('id',$item->project_id)->where('show_website',1))
            ...
            <aside id="thank-you" class="col-md-4 col-xs-12">
                @include('admin.error')
                @if(@auth('lead')->user())
