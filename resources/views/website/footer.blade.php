            ...
            <div class="col-md-3 col-sm-6">
                <div class="footer_panel bottom30">
                    ...
                    <h3 class="text-center" style="color: #fff;">
                        <a style="color: white" href="tel:{{ @App\HubPhone::first()->phone }}"><i class="fa fa-phone"></i> 
                            {{ @App\HubPhone::first()->phone }}</a>
                ...
                <div class="footer_panel bottom30">
                    ...
                    <div class="agetn-contact-2 bottom30">
                        <p>
                            ...
                            <a style="color: white" href="tel:{{ $phone->phone }}">{{ $phone->phone }}</a>
                            @if(!$loop->last) -
                             @endif @endforeach
                        </p>
                        <p><i class=" icon-icons142"></i> <a style="color: white" href="mailto:{{ $contact->email }}">{{ $contact->email }}</a></p>
