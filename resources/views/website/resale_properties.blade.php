                            ...
                            <div class="col-sm-6 not-filter">
                                <div class="property_item heading_space">
                                    ...
                                    @if(Session::get('Newlang') == 'ar')
                                        <a href="{{ url('ar/resale/'.slug($property->{app()->getLocale().'_title'}).'-'.$property->id) }}">
                                    @elseif(Session::get('Newlang') == 'en')
                                        <a href="{{ url('en/resale/'.slug($property->{app()->getLocale().'_title'}).'-'.$property->id) }}">
                                    @endif
                                          <img src="{{ url(''.$property->watermarked_image?: "") }}" alt="{{ $property->{app()->getLocale().'_title'} }}" class="img-responsive" />
                                        </a>
                                    ...
                                    <div class="proerty_content">
                                        <div class="proerty_text">
                                            <h3 class="captlize">
                                                @if(Session::get('Newlang') == 'ar')
                                                    <a href="{{ url('ar/resale/'.slug($property->{app()->getLocale().'_title'}).'-'.$property->id) }}">{{ $property->{app()->getLocale().'_title'} }}</a>
                                                @elseif(Session::get('Newlang') == 'en')
                                                    <a href="{{ url('en/resale/'.slug($property->{app()->getLocale().'_title'}).'-'.$property->id) }}">{{ $property->{app()->getLocale().'_title'} }}</a>
                                                @endif
                                            </h3>
