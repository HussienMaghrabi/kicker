            ...
            <div class="row " >
                ...
                <div class="col-md-7 text-right">
                    <ul class="breadcrumb_top">
                        ...
                        @if(auth('lead')->guest())
                            <li class="sub-menu-list"><a href="{{ url('request_units') }}"><i class="icon-icons215"></i>{{ __('admin.submit_property') }}</a></li>
                        @else
                            <li class="sub-menu-list"><a href="{{ url('add_properties') }}"><i class="icon-icons215"></i>{{ __('admin.submit_property') }}</a></li>
                        @endif
