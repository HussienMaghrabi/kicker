                            ...
                            <div class="col-sm-6 not-filter">
                                <div class="property_item heading_space">
                                    <div class="image">
                                        ...
                                        @endif
                                            <img src="{{ url(''.$property->image) }}" alt="{{ $property->{app()->getLocale().'_name'} }}" class="img-responsive">
                                        </a>
                                    ...
                                    <div class="proerty_content">
                                        <div class="proerty_text">
                                            <h3 class="captlize">
                                            @if(Session::get('Newlang') == 'ar')
                                                <a href="{{ url('ar/resale/'.slug($property->{app()->getLocale().'_title'}).'-'.$property->id) }}">{{ $property->{app()->getLocale().'_title'} }}
                                            @elseif(Session::get('Newlang') == 'en')
                                                <a href="{{ url('en/resale/'.slug($property->{app()->getLocale().'_title'}).'-'.$property->id) }}">{{ $property->{app()->getLocale().'_title'} }}
                                            @endif
                                                </a>
                                            </h3>
