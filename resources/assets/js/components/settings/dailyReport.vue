<template>
    <section class="container reports">
       ...
       <div>
        ...
        <b-button @click="viewRebort" type="is-info btn-get">GET</b-button>
...
<script>
import {LeadSources,getAllAgents,sendInfoTorebort} from './../../calls'
  ...
  methods: {
     getData(){
            ...
            viewRebort(){
              ...
              sendInfoTorebort(bodyFormData).then(response=>{
                  this.isLoading = false
