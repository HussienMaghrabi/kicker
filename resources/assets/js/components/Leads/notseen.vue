...
<script>
import {getNotSeen,deleteLead,switchLeads,searchForLead,getAgents,checkUserGroupAndRoles,deleteSelectedLeads} from './../../calls'
    ...
    export default {
        ...
        methods: {
            ...
            getData(scrollSwitch = false){
                this.isLoading = true
                getNotSeen(this.page).then(response=>{
            ...
            onPageChange(page) {
                this.page = page
                this.$router.replace({ name: "notseen", params: {page: page} })
                this.getData()
            },
            success(action) {
                this.$toast.open({
