...
changeLeadFav
<script>
    import {autoSwitchAPi,changeLeadFav,changeLeadHot,deleteLead,newLeadsFilter,getPublicData,switchLeads,getAgents,checkUserGroupAndRoles,searchForLead, getLeadSources, getLeadsByAgent, getBtns, addCall,bulkActions,deleteNoActionLeads,getAllProposal} from './../../calls'
    ...
    export default {
        ...
        getData(){
            this.isLoading = true
            getAllProposal(this.page).then(response=>{
