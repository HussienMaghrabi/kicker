        ...
        <b-table
            ...
            <template slot-scope="props">
                ...
                <b-table-column label="Actions">
                    <router-link :to="'/admin/vue/CustomeRole/'+props.row.id">
                        <b-button type="is-info">Custome Details</b-button>
                    </router-link>
    ...
    <b-modal :active.sync="Editmodal">
        <div class="modal-card" style="width: auto">
            ...
            <footer class="modal-card-foot" style="justify-content: flex-end;">
                <button class="button is-primary" @click="UpdateSingleRole(singleRole.id)">Edit <span class="fa fa-pen"></span></button>
...
import{
    ...
    export default {
        ...
        methods: {
            getAlldata(){
                getAllRoles(this.page).then(response=>{
            ...
            openEditmodal(RoleDID){
                this.isLoading = true
                this.Editmodal = true
                EditSingleRole(RoleDID).then(response=>{
                    this.isLoading = false
            ...
            UpdateSingleRole(RoleID){
                this.isLoading = true
                const data = {
                    'name':this.singleRole.name
                }
                updateSingleRole(RoleID,data).then(response=>{
            ...
            StoreRoleDetails(){
                ...
                storeSingleRole(data).then(response=>{
            ...
            DeleteRole(id){
                deleteSingleRole(id).then(response=>{
                    // console.log('deleted')
                    this.isLoading = true
                    this.getAlldata()
                })
