<template>
    <div>
            ...
            <div slot="page1">
                ...
                <div class="columns is-multiline is-mobile" style="padding-top: 1%;">
                    ...
                    <div class="column is-4">
                        <b-field label="Lead">
                            <b-autocomplete :class="{'input is-danger':  errors.lead_id}" v-model="newUnitData.lead_id"
                                ref="autocomplete" :data="filteredDataArray" placeholder="Lead"
                                :open-on-focus="openOnFocus"
                                @input="getLeadsAutocomplete"
                                @select="option => selected = option.key">
                    ...
                    <div class="control">
                        <div class="select is-fullwidth">
                            <select v-model="newUnitData.lead_id">
                                <option v-for="(lead, index) in leads" :key="index" :value="index">{{ lead }}</option>
                                <mugen-scroll :handler="getLeads" :should-handle="!loading">
                                  loading...
                                </mugen-scroll>
                            </select>
                        </div>
                    ...
                    <div class="column is-6">
                        <div class="field">
                            ...
                            <p class="help is-danger" v-if="errors.en_title">This field is required</p>
                        </div>
                    </div>
                    <div class="column is-6">
                        <div class="field">
                    ...
                    <div class="column is-6">
                        <div class="field">
                            ...
                            <div class="control">
                                ...
                                <p class="help is-danger" v-if="errors.en_description">This field is required</p>
                            </div>
                        </div>
                    </div>
        ...
        <b-modal v-model="showAddLead" :active.sync="showAddLead" hide-footer hide-header>
            ...
            saveUnit() {
                ...
                if (this.newUnitData.uniteAddType == 'resale') {
                    if (this.newUnitData.price && this.newUnitData.payment_method && this.newUnitData.originalPrice &&
                        ...
                        this.newUnitData.lead_id = this.selected
