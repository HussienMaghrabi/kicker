    ...
    <div>
         ...
         <div class="card">
           ...
           <div class="card">
              ...
              <div class="card-content">
                <div class="columns is-multiline">
                  ...
                  <div class="column is-6">
                    <div class="field">
                      <b-field label="Arabic Notes">
                        <b-input v-model="unitInfo.ar_notes" maxlength="200" type="textarea"></b-input>
                      </b-field>
                    </div>
                  </div>
                  <div class="column is-6">
                    <div class="field">
                      <b-field label="English Notes">
                        <b-input v-model="unitInfo.en_notes" maxlength="200" type="textarea"></b-input>
                      </b-field>
                    </div>
                  </div>
                </div>
                ...
                <div class="columns is-multiline">
                  ...
                  <div class="column is-4">
                    <b-field label="Unit Type">
                        <b-select v-model="unitInfo.unit_type_id">
                  ...
                  <div class="column is-6">
                    <b-field label="Original Price">
                        <b-numberinput type="is-info" v-model="unitInfo.original_price" min="0">
                        </b-numberinput>
                    </b-field>
                  </div>
                  <div class="column is-6">
                    <b-field label="Paid">
                        <b-numberinput type="is-info" v-model="unitInfo.paid" min="0">
                        </b-numberinput>
                    </b-field>
                  </div>
                  <div class="column is-6">
                    <b-field label="Rest">
                        <b-numberinput type="is-info" v-model="unitInfo.rest" min="0">
                        </b-numberinput>
                    </b-field>
                  </div>
                  <div class="column is-6">
                    <b-field label="Total">
                        <b-numberinput type="is-info" v-model="unitInfo.total" min="0">
                        </b-numberinput>
                    </b-field>
                  </div>
                  <div class="column is-6">
                    <b-field label="Due Now">
                        <b-numberinput type="is-info" v-model="unitInfo.due_now" min="0">
                        </b-numberinput>
                    </b-field>
                  </div>
                  <div class="column is-6">
                  ...
                  <div class="column is-6">
                    <b-field label="Price">
                        <b-numberinput type="is-info" v-model="unitInfo.price" min="0">
                        </b-numberinput>
                    </b-field>
                  </div>
                  <div class="column is-6">
                  ...
                  <div class="column is-6">
                    <div class="field">
                      <b-field label="Youtube Link">
                        <b-input v-model="unitInfo.youtube_link"></b-input>
                      </b-field>
                    </div>
                  </div>
                  <div class="column is-6">
                    <b-field label="Payment Method">
                      <b-select v-model="unitInfo.payment_method">
                  ...
                  <div class="column is-6">
                    <b-field label="Featured">
                      <div class="field">
                          <b-switch v-model="unitInfo.featured"
                              type="is-info"
                              true-value="1"
                              false-value="0">
                              <span v-if="unitInfo.featured == 1">Yes</span>
                              <span v-if="unitInfo.featured == 0">No</span>
                          </b-switch>
                      </div>
                    </b-field>
                  </div>
          ...
          <footer class="card-footer cardHeader" style="padding: 1rem">
            <b-button type="is-info" @click="editResale">Save</b-button>
          </footer>
          </div>
         </div>
    </div>
...
export default {
  ...
  methods: {
    getData(loading = true){
        ...
        getResaleEditData(this.id).then(response=>{
            const unit = response.data.unit
            var unitInfo = {}
            this.unitInfo = Object.assign(unitInfo,unit);
            this.usage =  this.unitInfo.type
            this.getUnitTypes(this.usage);
            // console.log('usaaage',this.usage)
            this.leads = response.data.leads
            this.allFacilities = response.data.allFacilities
            this.allLocations = response.data.allLocations
            console.log("Unit infooo",this.unitInfo)
    ...
    getUnitTypes(usage) {
      getUnitTypes({
        ...
        // console.log('typppee',this.usage)
        // console.log("reponse unit types",response)
          this.unitTypes = response.data
          console.log("unit typess",this.unitTypes)
      })
      .catch(error => {
          console.log(error)
      })
    ...
    editResale() {
      ...
      editResale(bodyFormData).then(response=>{
