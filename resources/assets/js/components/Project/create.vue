                ...
                <section class="container tasks">
                    <div class="column first">
                        <div class="columns is-multiline is-mobile" style="margin-bottom:20px">
                            ...
                            <div class="column is-12">
                                <button type="button" class="button is-primary is-meduim mr-10 import-excel" @click="storeProject">Save</button>
                            </div> 
                        </div>
                    </div> 
                </section>
...
<script>
import {storeProject,getAllDevelopers,getFacilities,getAllTags,getAllLocations} from './../../calls'
    ...
    data() {
        ...
        methods: {
            ...
            storeProject(){
                ...
                bodyFormData.append('delivery_date',this.project.dv);
                bodyFormData.append('zoom',15);
                bodyFormData.delete('dv');
                ...
                //     bodyFormData.set(key, value);
                // }
                storeProject(bodyFormData,this.id).then(response=>{
