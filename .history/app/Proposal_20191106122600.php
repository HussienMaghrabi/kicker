...
class Proposal extends Model
{
    ...
    static function ShowProposal($id)
    {
        ...
        ->select('proposal.id as id','company.id as lead_id','company.name as lead_name','contact.id as contact_id','contact.first_name as contact_first_name','contact.last_name as contact_last_name','carrancy.id as carrancy_id','carrancy.name as carrancy_name','p_company as company_id','p_company.name as company_name')
