...
class nationalVication extends Model
{
    ...
    public function GetAll()
    {
        ...
        ->select('n_vacation.id as id','n_vacation.created_at','n_vacation.updated_at','n_vacation.en_name','n_vacation.ar_name','n_vacation.days','n_vacation.natoial_vacation_type_id','n_vacation.from','n_vacation.to')
