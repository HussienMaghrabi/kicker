...
class employee_request extends Model
{
    ...
    static function updateRequestFromProfile($request,$id)
    {
        $updateR = employee_request::find($id);
        $updateR->days = $request->days;
        $updateR->request_type_id = $request->request_type_id;
        $updateR->note = $request->note;
        $updateR->note = $request->note;
        $updateR->date_from = $request->date_from;
        $updateR->date_too = $request->date_too;
