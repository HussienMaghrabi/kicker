...
class Proposal extends Model
{
    ...
    static function allProposal(){
        ...
        ->select('prop.id as id','company.name as company_name','contact.first_name as contact_first_name','contact.last_name as contact_last_name','currency.name as currency_name','prop_company.name as MCompany_name','prop.date')
        ->get();
