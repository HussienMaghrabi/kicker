...
class Proposal extends Model
{
    ...
    static function allProposal(){
        ...
        ->select('prop.id as id','company.name as company_name','contact.first_name as contact_first_name','contact.last_name as contact_last_name','currencies.name as currency_name','proposed_company.name as MCompany_name','prop.date')
        ->get();
