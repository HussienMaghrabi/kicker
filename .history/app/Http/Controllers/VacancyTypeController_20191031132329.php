...
class VacancyTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $checkVacancyName =  vacancy_type::where('name',$request->name)->first();
            if($checkVacancyName){
    ...
    public function update(Request $request,$id){
        ...
        if ($validator->fails()) {
            ...
            $checkVacancyName =  vacancy_type::where('name',$request->name)->where('id','!=',$id)->first();
            if($checkVacancyName){
                return response()->json([
                    'data' => 'bad request',
                    'massege' => 'NameTaken'
                ...
                vacancy_type::whereId($id)->update($request->all());
