...
class employee_attendance_controller extends Controller
{
    ...
    public function reportAllAttendance()
    {
        ...
        ->select('attendance.id as id','attendance.from_time','attendance.too_time','attendance.created_at','employee.en_first_name','employee.en_last_name','attendance.created_at','employee.email','employee.id')
        ->get();
        return $allAtendance;
    }
}
