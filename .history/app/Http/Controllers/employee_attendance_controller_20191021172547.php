...
class employee_attendance_controller extends Controller
{
    ...
    public function reportAllAttendance()
    {
        ...
        ->select('attendance.id as id','attendance.from_time','attendance.too_time','attendance.created_at','employees_en_first_name','employees.en_last_name','employees.email','employees.id')
        ->get();
    }
}
