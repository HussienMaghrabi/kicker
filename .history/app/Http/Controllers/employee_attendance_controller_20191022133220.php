...
class employee_attendance_controller extends Controller
{
    public function saveemployeeattendance(Request $request){
        ...
        if($employeeAttendance->id > 0){
            ...
            $uperLat = $getLocation->lat = $getLocation->lat + 0.5;
            $downLat = $getLocation->lat = $getLocation->lat - 0.5;
            $uperlng = $getLocation->lng = $getLocation->lng + 0.5;
            $downlang = $getLocation->lng = $getLocation->lng - 0.5;
