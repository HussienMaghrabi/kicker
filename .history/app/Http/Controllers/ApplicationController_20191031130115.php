...
class ApplicationController extends Controller
{
    ...
    public function index()
    {
        ...
        $applicationss = DB::table('applications as app')
                      ...
                      ->leftjoin('job_categories as job_cat','app.job_category_id','=','job_cat.id')
                      ->select('app.id','app.job_title_id','title.en_name as jobTitle','app.first_name','app.linkedin','app.cv'
                      ,'app.acceptness as acceptness','job_cat.en_name as en_department','job_cat.ar_name as ar_department')
                      ->paginate(100);
    ...
    public function searchApps(Request $request){
        ...
        if (Auth::user()->type === 'admin') {
            $Apps = DB::table('applications as app')
                    ...
                    ->select('app.id','app.job_category_id','category.en_name as en_department','app.first_name','app.linkedin','app.cv'
                    ,'app.acceptness as acceptness')
                    ->get();
            return $Apps;
        }
    ...
    public function filterApplications(Request $request){
        ...
        $applications = $applications->select('app.id','app.job_category_id','category.en_name as en_department','app.first_name',
        'app.linkedin','app.cv','app.acceptness as acceptness')->get();
