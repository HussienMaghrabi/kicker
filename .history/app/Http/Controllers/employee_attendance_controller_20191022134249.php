...
class employee_attendance_controller extends Controller
{
    public function saveemployeeattendance(Request $request){
        ...
        if($employeeAttendance->id > 0){
            ...
            $uperLat = $getLocation->lat = $getLocation->lat + 0.005;
            $downLat = $getLocation->lat = $getLocation->lat - 0.005;
            $uperlng = $getLocation->lng = $getLocation->lng + 0.005;
            $downlang = $getLocation->lng = $getLocation->lng - 0.005;
