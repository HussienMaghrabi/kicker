...
class employee_attendance_controller extends Controller
{
    ...
    public function reportAllAttendance()
    {
        ...
        ->select('attendance.id as id','attendance.attend_time','attendance.too_time','attendance.created_at','employee.en_first_name','employee.en_last_name','employee.email')
        ->get();
        return $allAtendance;
    }
}
