                    ...
                    <section class="modal-card-body">
                        <div class="columns is-multiline is-mobile">
                            ...
                            <div class="column is-6">
                                ...
                                <b-datepicker
                                    v-model="NewRequest.from"
                                    placeholder="Click to select..."
                                    icon="calendar-today"
                                ></b-datepicker>
                                </b-field>
                                <!-- <p class="help is-danger" v-if="errors.from">This field is required</p> -->
                            </div>

                            <div class="column is-6">
                                <b-field label="To Date">
                                <b-datepicker
                                    v-model="NewRequest.to"
                                    placeholder="Click to select..."
                                    icon="calendar-today"
                                ></b-datepicker>
                                </b-field>
                                <!-- <p class="help is-danger" v-if="errors.to">This field is required</p> -->
                            </div>
                        </div>
                    </section>
