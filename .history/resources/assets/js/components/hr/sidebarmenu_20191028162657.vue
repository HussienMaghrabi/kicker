...
<div>
        <div id="mySidebar" class="sidebar"> 
            ...
            <router-link :to="'/admin/vue/vacancy_type'"><i class="fas fa-briefcase"></i>    Vacancies Type</router-link>
            <router-link :to="'/admin/vue/request_type'"><i class="fas fa-briefcase"></i>    Request Type</router-link>
            <router-link :to="'/admin/vue/request_status'"><i class="fas fa-briefcase"></i>    Request Status</router-link>
            <router-link :to="'/admin/vue/employee_request'"><i class="fas fa-briefcase"></i>    Employee Request</router-link>
            <router-link :to="'/admin/vue/NationalVacation'"><i class="fas fa-briefcase"></i>    National Vacation</router-link>
            <router-link :to="'/admin/vue/vacations_type'"><i class="fas fa-briefcase"></i>    Vacation Type</router-link>
            ...
            <router-link :to="'/admin/vue/employee_attendance'"><i class="fas fa-briefcase"></i>    Employee Attendance</router-link>
            <router-link :to="'/admin/vue/attendance'"><i class="fas fa-users"></i>     Attendances</router-link>
            <router-link :to="'/admin/vue/attendance_report'"><i class="fas fa-users"></i>     Attendance Report</router-link>
            ...
            <router-link :to="'/admin/vue/deductionreport'"><i class="fab fa-critical-role"></i>  Dedtction Report</router-link>
            <router-link :to="'/admin/vue/GrossReport'"><i class="fab fa-critical-role"></i>  Gross Salary Report</router-link>
