...
import {showThisEmployee,deleteThisEmployee,filterEmployees,action_logs,callstatus,getMeetingStatus,updateEmployees
     ,getcities,getCountries,getVacancyInputs,EmployeeSalaryDetails,storeEmployeeContact,getAllJobTitles,EmployeeContacts,uploadEmployeeRequest,getRequestTypes,empRequestVacation,GetEmpVacationData} from './../../calls'
export default {
    data() {
            return {
