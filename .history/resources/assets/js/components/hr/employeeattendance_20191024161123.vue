                            ...
                            <div class="column">
                                <div class="column is-12">
                                    ...
                                    <gmap-marker
                                        ...
                                        :position="m.position"
                                        :draggable="true"
                                        :icon=" url('/assets/img/marker-a.png')"
                                    ></gmap-marker>
                                    </gmap-map>
                                </div>
                            </div>
    ...
    methods:{
        ...
        SaveNewAttend(){
            ...
            saveEmployeeAttendance(data).then(response=>{
                this.alertsuccess('Attendance Successfuly')
                this.AllEmployees()
            }).catch(error=>{
                console.log(error)
            })
        ...
        this.center.lat = vm.position.latitude
        this.center.lng = vm.position.longitude
        this.markers[0].position.lng = vm.position.longitude
        this.markers[0].position.lat = vm.position.latitude
