        ...
        <section>
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <br>
                    <div class="columns is-multiline is-mobile">
                        <div v-for="(detail,index) in AllDetails" :key="detail.id" class="column is-4">
                            <div class="field">
                                <b-switch :v-model="Selector[index].detail"  :true-value="detail.id" false-value="0">{{ detail.name }}</b-switch>
                            </div>
                            <br>
                        </div>
                    </div>
