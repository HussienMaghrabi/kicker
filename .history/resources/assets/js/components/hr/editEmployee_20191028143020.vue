           ...
           <div class="column is-4">
              ...
              <b-field>
                    <b-select placeholder="Choose Options" expanded v-model="employee.gender">
                        <option v-if="employee.gender == 'male'" selected value="Male">Male</option>
                        <option  v-else value="female">Female</option>
                        <option v-if="employee.gender == 'female'" selected value="female">Female</option>
                        <option  v-else value="male">Male</option>
                    </b-select>
              </b-field>
