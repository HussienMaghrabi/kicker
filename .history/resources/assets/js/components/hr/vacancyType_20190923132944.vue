                    ...
                    <div class="columns padding">
                        <div class="column is-12">
                            <b-table
                                ...
                                <template :slot-scope="VacansiesType">
                                
                                    <b-table-column class="width" field="id" label="Name" sortable>
                                        {{ VacansiesType.row.name }}
                                    </b-table-column>

                                    <b-table-column label="Update">
                                        <b-button type="is-warning">
                                            <router-link :to="'/admin/vue/editJobCategory/'+VacansiesType.row.id" style="color:#000;">
                                                Update
                                            </router-link>
                                        </b-button>
                                    </b-table-column>
                                    ...
                                    <b-button type="is-danger" @click="DeleteFromIndex(VacansiesType.row.id)">Delete</b-button>
                                    </b-table-column>
