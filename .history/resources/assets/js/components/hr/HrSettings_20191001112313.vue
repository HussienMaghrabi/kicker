         ...
         <div class="columns is-12" style="">
             <div class="Employee-details column is-6" style="border-top: 3px solid #b07d12;">
                    ...
                    <b-field label="Choose Employee" class="column is-12">
                        <b-select v-model="GroosSalary.employeeGSalary" expanded>
                        ...
                        <div class="column is-6">
                         ...
                         <div class="column is-6">
                            <b-field label="Allowances:">
                              <b-input type="number" v-model="GroosSalary.allowances"></b-input>
                            </b-field>
                        </div>
                    </div>
...
import {allEmployees,deleteThisEmployee,filterEmployees,action_logs,callstatus,getMeetingStatus,getAllEmployees,getHrSettingData,updateHrSettings,UpdateGroosSalary} from './../../calls'
export default {
    data() {
            return {
