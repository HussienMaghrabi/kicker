                           ...
                           <b-modal :active.sync="isComponentModalActive" has-modal-card>
                            <div class="modal-card" style="width: auto">
                                ...
                                <b-field label="Reason">
                                   <b-input v-model="vacation.reason" type="text" placeholder="Reason"></b-input>                                    
                                </b-field>

                                <b-field label="Start date">
                                   <b-input v-model="vacation.start_date" type="date"></b-input>
                                </b-field>

                                <b-field label="End Type">
                                   <b-input v-model="vacation.end_days" type="date"></b-input> 
                                </b-field>
                                
                                 <div class="block">
                                    <b-radio v-model="vacation.vacation_status"
                                        name="name"
                                        native-value="Annaul_Vacation"
                                        >
                                        Annaul Vacation
                                    </b-radio>
                                    <b-radio 
                                        v-model="vacation.vacation_status"
                                        name="name"
                                        native-value="Unscheduled_Vacation">
...
import {showThisEmployee,deleteThisEmployee,filterEmployees,action_logs,callstatus,getMeetingStatus,updateEmployees
     ,getcities,getCountries,getVacancyInputs,EmployeeSalaryDetails,storeEmployeeContact,getAllJobTitles,EmployeeContacts,uploadEmployeeRequest} from './../../calls'
export default {
    data() {
            return {
