...
<script>
import {
    getVacationType,StoreNewNationalVacType,DeleteNationalVacType,getSinglevacationType,updateVacation
} from './../../calls'
...
export default {
    ...
    methods:{
        getData(){
            getVacationType(this.page).then(response=>{
        ...
        TypeDeletecon(id){
            this.isLoading = true
            DeleteNationalVacType(id).then(response=>{
                this.isLoading = false
        ...
        StoreNewType(){
            ...
            StoreNewNationalVacType(data).then(response=>{
                this.isLoading = false
                this.NewType = ''
                this.AddModel = false
                this.getData()
        ...
        openEditForm(id){
            getSinglevacationType(id).then(response=>{
        ...
        editType(){
            ...
            updateVacation(this.TypeID,data).then(response=>{
                this.isLoading = false
                this.NewType = ''
                this.editmodal = false
                this.alertsuccess('Type is update')
                this.getData()
            }).catch(error=>{
                console.log(error)
            })
