                                        ...
                                        <div class="column is-5 border_right">
                                            <div class="head_margin_top">
                                                ...
                                                <span v-if="edit.weekends" id="weekends_input" class="">
                                                    <multiselect :close-on-select="false" v-model="Days.id"  tag-placeholder="Add this as new tag" placeholder="Select Days" label="day" track-by="id" value="status_day" :options="Days" :multiple="true" :taggable="true"></multiselect>
                                                </span>
                                            </div>
                                        </div>
