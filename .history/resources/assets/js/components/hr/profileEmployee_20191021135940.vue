...
import {showThisEmployee,deleteThisEmployee,filterEmployees,action_logs,callstatus,getMeetingStatus,updateEmployees
     ,getcities,getCountries,getVacancyInputs,EmployeeSalaryDetails,storeEmployeeContact,getAllJobTitles,EmployeeContacts,uploadEmployeeRequest,getRequestTypes} from './../../calls'
export default {
    data() {
            return {
