...
<script>
import {
    getVacancyType,StoreNewVacType,DeleteVacType,getVacTypeData,updateVacancy
} from './../../calls'
    ...
    methods:{
        ...
        StoreNewType(){
            ...
            StoreNewVacType(data).then(response=>{
                this.isLoading = false
                if(response.data.massege == 'NameTaken'){
                    this.alertdanger('Vacancy name alredy taken')
                }else{
                    this.NewType = ''
                    this.AddModel = false
                    this.getData()
        ...
        editType(){
            ...
            updateVacancy(this.TypeID,data).then(response=>{
                this.isLoading = false
                if(response.data.massege == 'NameTaken'){
                    this.alertdanger('Vacancy name alredy taken')
                }else{
