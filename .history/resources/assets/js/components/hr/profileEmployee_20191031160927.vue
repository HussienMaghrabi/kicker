    ...
    <section class="container">
       ...
       <div class="columns">
                ...
                <b-tabs v-model="activeTab">
                    ...
                    <b-tab-item  label="Request Vacation">
                        <div class="box-header with-border headerr">
                           ...
                           <b-modal :active.sync="isComponentModalActive" has-modal-card>
                            <div class="modal-card" style="width: auto">
                                ...
                                <b-field label="Number Of Days">
                                   <b-input v-model="vacation.days" type="number" placeholder="Number Of Days"></b-input>
                                </b-field>

                                <b-field label="Reason">
                                   <b-input v-model="vacation.note" type="text" placeholder="Reason"></b-input>                                    
                                </b-field>

                                <b-field label="Start date">
                                   <b-input v-model="vacation.date_from" type="date"></b-input>
                                </b-field>

                                <b-field label="End Type">
                                   <b-input v-model="vacation.date_too" type="date"></b-input> 
                                </b-field>
                            ...
                            <div class="">
                                ...
                                <div class="control">
                                    <div class="select is-fullwidth">
                                        <select v-model="vacation.request_type_id">
                                ...
                                <footer class="modal-card-foot">
                                    ...
                                    <b-button @click="AddRequestvacation" class="is-success">Upload</b-button>
                                </footer>
                            </div>
                        </b-modal>
                          ...
                          <b-table
                            ...
                            <template slot-scope="props">
                                ...
                                <b-table-column class="width" label="Vacation Payment" sortable>
                                    <b-button v-if="props.row.status_id == 1" @click="UpdateEmpVacation(props.row.id)" type="is-primary">Update</b-button>
                                    <b-button v-else disabled type="is-primary">Update</b-button>
                                </b-table-column>
                        ...
                        <b-modal :active.sync="isComponentModalActive" has-modal-card>
                            <div class="modal-card" style="width: 160%">
                                ...
                                <b-field label="Relation">
                                   <b-input type="text" v-modal="Relations" placeholder="Relation"></b-input>
                                </b-field>
                ...
                <div class="modal-card" style="width: auto">
                    ...
                    <section class="modal-card-body">
                    <b-field label="Number Of Days">
                        <b-input v-model="vacationEmployee.days" type="number" placeholder="Number Of Days"></b-input>
                    </b-field>

                    <b-field label="Reason">
                        <b-input v-model="vacationEmployee.note" type="text" placeholder="Reason"></b-input>                                    
                    </b-field>

                    <b-field label="Start date">
                        <b-input v-model="vacationEmployee.date_from" type="date"></b-input>
                    </b-field>

                    <b-field label="End Type">
                        <b-input v-model="vacationEmployee.date_too" type="date"></b-input> 
                    </b-field>
                ...
                <div class="">
                    ...
                    <div class="control">
                        <div class="select is-fullwidth">
                            <select v-model="vacationEmployee.request_type_id">
                                <option v-for="type in Types" :key="type.id" :value="type.id">{{type.name}}</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <footer class="modal-card-foot">
                        ...
                        <b-button @click="updateRequest(vacationEmployee.id)" class="is-success">Upload</b-button>
                    </footer>
                </div>
            </b-modal>
     </section>
...
import {showThisEmployee,deleteThisEmployee,filterEmployees,action_logs,callstatus,getMeetingStatus,updateEmployees
     ,getcities,getCountries,getVacancyInputs,EmployeeSalaryDetails,storeEmployeeContact,getAllJobTitles,EmployeeContacts,uploadEmployeeRequest,getRequestTypes,empRequestVacation,GetEmpVacationData,updateRequestvacation} from './../../calls'
export default {
    data() {
            return {
        ...
        AllRequestVacation(){
            empRequestVacation(this.id).then(response=>{
                this.AllEmployeeRequset = response.data
            }).catch(error=>{
                console.log(error)
            })
        },
        AddRequestvacation(){
            ...
            const bodyFormData = new FormData;
                for (let key in this.vacation) {
                    const value = this.vacation[key];
                    bodyFormData.set(key, value);
                }
                bodyFormData.append('employee_id',this.id)
                uploadEmployeeRequest(bodyFormData).then(response=>{
                    // console.log(response)
                    this.isComponentModalActive = false
                    this.alertsuccess('Add New Request Vacation')
                    this.getEmployeesData();
                }).catch(error=>{
                    console.log(error)
                })
     ...
     StoreContact(){
         ...
         bodyFormData.append('relation',this.Relations)
         bodyFormData.append('employee_id',this.id)
    ...
    Addphonefield: function() {
        ...
        UpdateEmpVacation(requestId){
            this.isLoading = true
            this.EditModal = true
            GetEmpVacationData(requestId).then(response=>{
                this.isLoading = false
                this.vacationEmployee = response.data.data
            }).catch(error=>{
                console.log(error)
            })
        },
        updateRequest(RequestId){
            ...
            for (const key in this.vacationEmployee) {
                const value = this.vacationEmployee[key];
                bodyFormData.set(key, value);
            }
            updateRequestvacation(RequestId,bodyFormData).then(response=>{
                this.EditModal = false
                this.alertsuccess('Update Request Vacation')
                this.getEmployeesData()
            }).catch(error=>{
                console.log(error)
            })
