                        ...
                        <div class="column is-12">
                            <b-table
                                ...
                                <template slot-scope="props">
                                    ...
                                    <b-button  size="is-small" @click="editType(props.row.id)"><span style="color:green" class="fa fa-edit"></span></b-button>
                                    <b-button type="is-danger" size="is-small" @click="DeleteFromIndex(props.row.id)"><span class="fa fa-trash"></span></b-button>
                                    </b-table-column>
