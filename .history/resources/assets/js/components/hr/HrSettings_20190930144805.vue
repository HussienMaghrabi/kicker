                                 ...
                                 <div class="columns is-multiline">
                                     ...
                                     <div class="column is-1 border_right"> </div>
                                        ...
                                        <div class="column is-5 head_margin_top">
                                         ...
                                         <div class="column is-5 head_margin_top">
                                            End Work :
                                            <!-- <span v-if="!edit.ar_days" id="ar_days" class="">
                                                {{ getleads.lead.days_ar }}
                                            </span>
                                            <i v-if="!edit.ar_days" @click="fn_edit('ar_days')" -->
                                            <i   class="fa fa-edit update pull-right"
                                                style="font-size: 20px; cursor: pointer" type="ar_days"
                                                id="ar_days"></i>
                                            ...
                                            <!-- <i v-if="edit.ar_days" @click="fn_edit('ar_days')"
                                                ...
                                                id="ar_days"></i>
                                            <span v-if="edit.ar_days" id="ar_days" class="">
                                                <input type="text" v-model="updatelead.ar_days" class="update_input" value="arabic first name"
                                                    id="ar_days">
                                            </span> -->
                                        </div>
         ...
         methods:{
            getData(){
                getHrSettingData().then(response=>{
                    ...
                    this.HrSettings = response.data[0].HrData
