                        ...
                        <b-modal :active.sync="isComponentModalActive" has-modal-card>
                            <div class="modal-card" style="width: 160%">
                               ...
                               <div class="card">
                                ...
                                <footer class="modal-card-foot">
                                    <button class="button" type="button" @click="isComponentModalActive = false">Close</button>
                                    <b-button @click="StoreContact" class="is-success">Remove</b-button>
                                </footer>
                            </div>
                        </b-modal>
...
import {showThisEmployee,deleteThisEmployee,filterEmployees,action_logs,callstatus,getMeetingStatus,updateEmployees
     ,getcities,getCountries,getVacancyInputs,EmployeeSalaryDetails} from './../../calls'
export default {
    data() {
            return {
     ...
     StoreContact(){
         console.log('sadsad')
        storeEmployeeContact().then(response=>{
