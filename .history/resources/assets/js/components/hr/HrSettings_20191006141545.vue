                    ...
                    <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr v-for="national in AllNationalVacation" :key="national.id">
                                    ...
                                    <td>{{ national.from }}</td>
                                    <td>{{ national.to }}</td>
                                    <td><span @click="UpdateInModel"><i class="fa fa-edit" style="color:green"></i></span><span @click="DeleteNational(national.id)"><i class="fa fa-trash" style="color:red"></i></span></td>
                                </tr>
                ...
                <div class="modal-card" style="width: auto">
                    ...
                    <section class="modal-card-body">
                        <div class="columns is-multiline is-mobile">
                            ...
                            <div class="column is-6">
                                <b-field label="Type">
                                    <b-select v-model="updateVcation.natoial_vacation_type_id">
                                        <option v-for="type in vacationTypes" :value="type.id" :key="type.id">{{ type.name }}</option>
                                    </b-select>
                                </b-field>
                            </div>
                            <div class="column is-6">
                                <b-field label="Start date">
                                    <b-input type="date" v-model="updateVcation.from"></b-input>
                                </b-field>
                            </div>
                            <div class="column is-6">
                                <b-field label="End date">
                                    <b-input type="date" v-model="updateVcation.to"></b-input>
                                </b-field>
                            </div>
                        </div>
                    </section>
...
import {allEmployees,deleteThisEmployee,filterEmployees,action_logs,callstatus,getMeetingStatus,getAllEmployees,getHrSettingData,updateHrSettings,UpdateGroosSalary,employeeDeductionUpdate,GetAllVacatonType,addNewNational,GetVacationOfNational,DeleteNationalVacation,getSingleNVacation} from './../../calls'
export default {
    data() {
            return {
        ...
        UpdateInModel(NaVacationID){
            ...
            getSingleNVacation(NaVacationID).then(Response=>{
                this.updateVcation = response.data
            }).catch(error=>{
                console.log(error)
            })
        },
