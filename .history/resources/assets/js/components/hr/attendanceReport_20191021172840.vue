                        ...
                        <div class="column is-12">
                            <b-table
                                ...
                                <template slot-scope="props">
                                    ...
                                    <b-table-column field="attendance.deduction" label="Deduction" width="40" sortable>
                                        {{ props.row.deduction }}
                                    </b-table-column>
                                    <b-table-column field="attendance.details" label="Details" width="40" sortable>
                                        {{ props.row.details }}
                                    </b-table-column>
                                    <b-table-column field="attendance.order_by" label="Order By" width="40" sortable>
                                        {{ props.row.order_by }}
                                    </b-table-column>
                                    <b-table-column field="attendance.date" label="Date" width="40" sortable>
                                        {{ props.row.date }}
                                    </b-table-column>
                                </template>
                            </b-table>
