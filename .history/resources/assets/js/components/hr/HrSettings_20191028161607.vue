    ...
    data() {
        ...
        AddNationalVacation(){
            ...
            addNewNational(bodyFormData).then(response=>{
                this.alertsuccess('Add New National Vacation')
                this.getData()
                // console.log(response)
            }).catch(error=>{
                console.log(error)
        ...
        updateNVacation(){
            ...
            updateNVacany(bodyFormData).then(response=>{
                ...
                // console.log(response)
                this.alertsuccess('Update National Vacation')
                this.getData()
            }).catch(error=>{
                console.log(error)
            })
        ...
        fn_edit(value) {
            ...
            if (this.edit[value] == true) {
                ...
                updateHrSettings(bodyFormData).then(response=>{
                    this.alertsuccess('Custom Settings')
                    this.getData()
                    this.isLoading = false
        ...
        deleteVacation(NationalID){
            ...
            DeleteNationalVacation(NationalID).then(response=>{
                this.alerterror('Delete National Vacation')
                this.getData()
            }).catch(error=>{
                console.log(error)
            })
        ...
        UpdateEmployeeSalary(){
            ...
            UpdateGroosSalary(bodyFormData).then(response=>{
                this.alertsuccess('Update Gross salary')
                this.getData()
                // console.log(response)
            }).catch(error=>{
                console.log(error)
        ...
        updateEmployeeDeduction(){
            ...
            employeeDeductionUpdate(bodyFormData).then(response=>{
                // console.log(response)
                this.alertsuccess('Update Deduction salary')
                this.getData()
            }).catch(error=>{
                console.log(error)
            })
