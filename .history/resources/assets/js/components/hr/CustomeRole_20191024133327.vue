                ...
                <div class="card-content">
                    ...
                    <div class="columns is-multiline is-mobile">
                        <div v-for="detail in AllDetails" :key="detail.id" class="column is-4">
                            <div class="field">
                                <b-switch v-model="Selector" true-value="1" false-value="0">{{ detail.name }}</b-switch>
                            </div>
                            <br>
                        </div>
                    </div>
                    <div class="columns is-multiline is-mobile">
                        <b-button @click="UpdateRoles" type="is-primary">Primary</b-button>
                    </div>
                </div>
            </div>
        </section>
...
export default {
    ...
    methods:{
        ...
        UpdateRoles(){
            console.log('pushing array to backend')
        }
    },
}
</script>
