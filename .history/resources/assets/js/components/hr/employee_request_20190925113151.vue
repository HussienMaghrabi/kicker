...
<script>
import {
    GetEmployeeRequests,ChangeRequestStatus,getAllStatusOfRequest,DeleteEmployeeRequest,UpdateRequestEmployee,getAllEmployees
} from './../../calls'
    ...
    methods:{
        ...
        AllEmployees(){
            ...
            this.isLoading = false
                ...
                console.log('All Emp',this.Employees)
            }).catch(error=>{
                console.log(error)
            })
        },
