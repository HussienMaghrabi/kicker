            ...
            <div class="column is-12">
                <table class="responsive-table">
                    ...
                    <tr  v-for="(invoice, k) in invoices" :key="k">
                        <td>
                            <b-field>
                                <b-select v-model="invoices[k].itemName" placeholder="Select item"  expanded >
                        ...
                        <td>
                            <div class="cell-with-input"><b-input type="number" min="0" v-model="invoice.itemQuantity"/></div>
                        </td>
                        <td>
                            <div class="cell-with-input"><b-input type="number" min="0"  v-model="invoice.itemPrice"/></div>
                        </td>
                        <td>
                            {{ invoice.total }}
                        </td>
                        <td>
                            <b-input type="number" placeholder="Value" min="0"  readonly v-model="invoice.discountValue"/>
                        </td>
                        <td>
                            <b-input type="number" placeholder="Percent %" min="0" @input="ChangeDiscount"  v-model="invoice.discount"/>
                        </td>
                        <td class="text-right"> 
                            {{ invoice.total }}
                        </td>
                        <td>
                            <i @click="deleteRow(k, invoice)" class="fas fa-trash-alt" style="cursor:pointer"></i>
                        </td>
                        <hr>
                    </tr>
                </table>
