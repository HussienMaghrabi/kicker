                ...
                <table class="responsive-table">
                    ...
                    <tr  v-for="(invoice,index) in invoices" :key="index">
                        ...
                        <td>
                            ...
                            <strong>{{ invoices[index].total = invoices[index].itemQuantity * invoices[index].itemPrice }}</strong>
                        </td>
                        <td>
                            ...
                            {{invoices[index].discountValue = invoices[index].total - invoices[index].discount /  100 }}
                        </td>
                        <td>
