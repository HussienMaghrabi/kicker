            ...
            <div class="column is-12">
                <table class="responsive-table">
                    ...
                    <tr  v-for="(invoice, k) in invoices" :key="k">
                        <td>
                            <b-field>
                                <b-select v-model="choseItem[k].itemName" placeholder="Select item"  expanded >
                        ...
                        <td><div class="cell-with-input"><b-input type="number" min="0" v-model="invoice.itemQuantity"/></div></td>
                        <td><div class="cell-with-input"><b-input type="number" min="0"  v-model="invoice.itemPrice"/></div></td>
                        <td>{{ invoice.total }} </td>
