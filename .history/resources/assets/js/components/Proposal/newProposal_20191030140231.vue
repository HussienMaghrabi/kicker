        ...
        <div class="columns is-12">
            <div class="column is-12">
                <table class="responsive-table">
                    ...
                    <tr  v-for="(invoice,index) in invoices" :key="k">
                        <td>
                            <b-field>
                                <b-select v-model="invoices[index].itemName" placeholder="Select item"  expanded >
                        ...
                        <td>
                            <input readonly v-model="invoices[index].total" :value=" invoices[index].itemQuantity * invoices[index].itemPrice" /><span> {{ invoices[index].itemQuantity * invoices[index].itemPrice}} </span>
                        </td>
                        <td>
                            <b-input type="number" placeholder="Value" min="0"  readonly v-model="invoices[index].discountValue"/>
                        </td>
                        <td>
                            <b-input type="number" placeholder="Percent %" min="0" @input="ChangeDiscount"  v-model="invoices[index].discount"/>
                        </td>
                        <td class="text-right"> 
