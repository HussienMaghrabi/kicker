...
class SalariesController extends Controller
{
    ...
    public function index()
    {
        ...
        //     "title"=>$title,
        //     "salaries"=>$salaries,
        //     "basic"=>$toltal_basic_salary,
        //     "gross"=>$total_gross,
        //     "net"=>$total_net,
        //     "full"=>$total_full_salary
        // ]);
    }
    ...
    public function searchSalary(Request $request){
        ...
        if (Auth::user()->type === 'admin' ) {
            $salaris = DB::table('salaries as salary')    
            ->where('salary.employee_id', 'LIKE', '%' . $search . '%')
            ->orwhere('salary.basic', 'LIKE', '%' . $search . '%')
            ->orwhere('salary.gross', 'LIKE', '%' . $search . '%')
            ->orwhere('salary.net', 'LIKE', '%' . $search . '%')
            ->orwhere('salary.full_salary', 'LIKE', '%' . $search . '%')
            ->select('salary.employee_id','salary.basic','salary.gross','salary.net','salary.full_salary')    
            ->get();
            return $salaris;
        }
    }
