...
class UnitTypeController extends Controller
{
    ...
    {
        $sources = UnitType::orderBy('id','desc')->paginate(5);
        return $sources;
//        $sources=
    ...
    public function getUnitTypeSelection(Request $request){
        return DB::table('unit_types')
        ->where('usage',$request->unit_type)
